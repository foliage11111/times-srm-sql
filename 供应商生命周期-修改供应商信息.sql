...
--资质信息
CUX_CREDENTIALS_INFO

--修改供应商标准表信息
select  * from AP_SUPPLIERS pv
where pv.VENDOR_NAME like '%佛山市唯格瓷砖有限责任公司%'  for update

select  * from AP_SUPPLIERS pv
where pv.VENDOR_NAME = '亚萨合莱国强（山东）五金科技有限公司'  for update
