--select usemoney.*,planmoney.*,usemoney.chas-planmoney.sumq
select sum (case
when usemoney.chas>planmoney.sumq
then
  usemoney.chas-planmoney.sumq
  else
    0
end
)
  from (
select used.category_code,sum(used.cha) chas
